    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          className={`min-h-[44px] w-full rounded-lg border px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 disabled:bg-slate-100 disabled:text-slate-500 ${
